...
import (
	...
	uuidgql1 "github.com/marcboeker/mega/ent/schema/timestampgql"
	"github.com/marcboeker/mega/ent/schema/uuidgql"
...
type ComplexityRoot struct {
	Mutation struct {
		CreateUser func(childComplexity int, user model.AddUserInput) int
	}
...
type MutationResolver interface {
	CreateUser(ctx context.Context, user model.AddUserInput) (*ent.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createUser":
		...
		return e.complexity.Mutation.CreateUser(childComplexity, args["user"].(model.AddUserInput)), true
...
var sources = []*ast.Source{
	{Name: "graph/schema/schema.graphqls", Input: `scalar Timestamp
`, BuiltIn: false},
...
func (ec *executionContext) field_Mutation_createUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["user"]; ok {
		...
		arg0, err = ec.unmarshalNAddUserInput2githubᚗcomᚋmarcboekerᚋmegaᚋgraphᚋmodelᚐAddUserInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateUser(rctx, args["user"].(model.AddUserInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*ent.User)
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋmarcboekerᚋmegaᚋentᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNAddUserInput2githubᚗcomᚋmarcboekerᚋmegaᚋgraphᚋmodelᚐAddUserInput(ctx context.Context, v interface{}) (model.AddUserInput, error) {
...
func (ec *executionContext) unmarshalNTimestamp2timeᚐTime(ctx context.Context, v interface{}) (time.Time, error) {
	res, err := uuidgql1.UnmarshalTimestamp(v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) marshalNTimestamp2timeᚐTime(ctx context.Context, sel ast.SelectionSet, v time.Time) graphql.Marshaler {
	res := uuidgql1.MarshalTimestamp(v)
	if res == graphql.Null {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋmarcboekerᚋmegaᚋentᚐUser(ctx context.Context, sel ast.SelectionSet, v *ent.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
